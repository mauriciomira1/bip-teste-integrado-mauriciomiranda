...
ALTER TABLE BENEFICIO ALTER COLUMN ID RESTART WITH 1;
...
INSERT INTO BENEFICIO (NOME, DESCRICAO, VALOR, ATIVO, VERSION) VALUES ('Beneficio Inativo', 'Inativo', 100.00, FALSE, 0);
